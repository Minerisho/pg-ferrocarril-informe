...
En la \cref{tab:epicas} se presentan las 8 épicas resultantes de esta categorización.
...
La \cref{tab:HU-final} presenta el formato consolidado de las historias de usuario tras el proceso de refinamiento continuo tras cada iteración durante las fases del proyecto. Se define las columnas de la siguiente manera:
...
\begin{enumerate}
    \item Jugador: En este ítem se encuentra todo lo referente al jugador, tales como el controlador de movimiento, la cámara y las funciones de deteccion y construccion de vías.
    \begin{enumerate}
...
\begin{figure}[H] 
\centering
\includegraphics[width=\linewidth,height=0.85\textheight,keepaspectratio]{figures/componentesnivel1a.png} 
...
\begin{figure}[H] 
\centering
\includegraphics[width=\linewidth,height=0.85\textheight,keepaspectratio]{figures/componentesnivel1b.png} 
...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{figures/uml_bd_nosql.png} 
...
\begin{figure}[H]
\centering
\includegraphics[width=0.5\textwidth]{figures/mapa_inicial (1).png}
...
\begin{minipage}{0.48\textwidth}
    ...
    \caption{Modelo de un puente.}
    \label{fig:puente}
\end{minipage}\hfill
\begin{minipage}{0.48\textwidth}
    \centering
    \includegraphics[width=\linewidth]{figures/tunel.png}
    \caption{Modelo de un túnel.}
    \label{fig:tunel}
\end{minipage}
\end{figure}
...
\begin{enumerate}
    ...
    \begin{figure}[H]
    \centering
    \includegraphics[width=0.4\textwidth]{figures/don_rail.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\textwidth]{figures/contratoPuntuación.png}
...
En las \cref{fig:dineroyesfuerzo,fig:encuestaaprendizaje} se muestran algunas de las respuestas de la preguntas 29 y 30. Esta pregunta fue hecha con énfasis en responder el objetivo del proyecto, el cual involucra saber el impacto que tuvo en los jugadores el videojuego serio.
