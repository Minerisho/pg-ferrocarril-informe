...
La fase de pruebas contó con la participación voluntaria de \textbf{22} personas de la comunidad universitaria.
...
\begin{itemize}
    ...
    \item \textbf{Renderización a larga distancia: } Al alejar la cámara, los rios y parte del terreno no se ven adecuadamente, lo que lleva a que parezca, en determinadas ocaciones, que no hay un rio cuando si lo hay, se recomiendo aumentar distancia de renderizado.
    \item \textbf{Don Raíl reaparece en el menú: } Al volver al menú principal, en determinadas ocaciones de las cuales no se ha determinado su causa, Don Raíl reaparece como si nunca se hubiera completado el tutorial, esto refleja que la variable "tutorialMenuCompletado" no esta cambiando su estado a True correctamente una vez se completa el tutorial de menú.
\end{itemize}