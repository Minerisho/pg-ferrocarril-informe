...
\begin{figure}[H]
\centering
% REEMPLAZA ESTA LÍNEA CON TU DIAGRAMA DE COMPONENTES GIGANTE
\framebox[\linewidth]{\rule{0pt}{14cm} [INSERTAR AQUÍ EL DIAGRAMA DE COMPONENTES POR ESCENAS]}
...
La razón en usar una base de datos No-SQL vs SQL se debe a la naturaleza de la arquitectura de datos en el desarrollo de un videojuego; es decir, durante sus ciclos de vida un videojuego a comparación de otros productos software, sufren muchos cambios a nivel de estructura de datos. Los videojuegos hoy en día en la industria suelen utilizar en su mayoría bases de datos no relacionales.
...
\subsection{Desarrollo del Sistema Ferroviario y Leyes Físicas}
...
\begin{itemize}
    ...
    \item \textbf{Explosión fuera de zona:} En el nivel 1 (Tutorial), se presenta un error cuando el tren explota dentro de una zona de daño. Al reintentar, el tren continúa recibiendo daño de manera periódica, como si aún permaneciera en dicha zona. La única forma de evitar este comportamiento es reiniciando el nivel por completo. Este problema requiere pruebas adicionales para identificar su causa y definir una solución adecuada.
    \item \textbf{Generación de puentes y túneles:} En determinadas condiciones del terreno, el sistema genera un túnel cuando en realidad debería colocarse un puente, lo que ocasiona situaciones poco coherentes, como que el tren cruce un río mediante un túnel. Este comportamiento se debe al método actual de detección de la estructura adecuada entre dos puntos. Se recomienda ajustar el algoritmo de detección para mejorar la precisión en la generación de estas construcciones.
\end{itemize}