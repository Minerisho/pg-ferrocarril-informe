...
Se desarrollo la siguiente encuesta en Google forms con el fin de que los jugadores la respondieran una vez terminaran su sesión en el videojuego serio, esta encuesta cuenta con un total de 30 preguntas entre las cuales hay preguntas abiertas, las preguntas abiertas no era obligatorio responderlas debido a que se trata de preguntas de percepcion de los jugadores, por lo que no fueron forzados a dar una opinión concreta del tema si no creen tenerla

\begin{figure}[H]
\centering
\includegraphics[width=1\textwidth]{figures/encuesta.png} 
\caption{Encuesta enviada a jugadores}
\label{fig:encuesta}
\end{figure}

La encuesta cuenta con las siguientes preguntas:
...
\begin{enumerate}
    ...
    \item Tras la experiencia de juego, ¿qué reflexiones adquirió respecto a la problemática del desarrollo de infraestructura férrea en el país?
\end{enumerate}
