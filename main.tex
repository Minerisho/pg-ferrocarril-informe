...
\setlength{\bibparsep}{1em}   % entre párrafos dentro de una entrada
...
\setlist[enumerate]{nosep} % Aplica a todas las listas numeradas
\setlist[itemize]{nosep}   % Aplica a todas las listas con viñetas
% Metadatos portada:
\icontecsetup{
